...
export const TRANSLATIONS: Record<Language, Record<string, string>> = {
  vi: {
    ...
    // Home
    'home.heroTitle': 'Villa và homestay cho những ngày nghỉ thật thoải mái',
    'home.heroSubtitle': 'Tìm chỗ ở phù hợp tại Đà Lạt, Vũng Tàu, Phú Quốc và nhiều điểm đến khác. Giữ chỗ nhanh, tư vấn rõ ràng qua Zalo.',
    ...
    'home.zaloBookingTitle': 'Tư vấn qua Zalo',
    'home.zaloBookingDesc': 'Bạn có thể nhắn Zalo để hỏi thêm về lịch trống, giá và cách xác nhận đặt phòng.',
...
export function LanguageProvider({ children }: { children: ReactNode }) {
  ...
  const [language, setLanguageState] = useState<Language>(() => {
    const saved = localStorage.getItem('HenryTravel_language');
  ...
  const setLanguage = (lang: Language) => {
    ...
    localStorage.setItem('HenryTravel_language', lang);
  };
