...
export default function AdminLayout({
  ...
  return (
    <div className="flex flex-1 min-h-0 w-full max-w-[1280px] flex-col gap-4 overflow-hidden px-4 pb-4 pt-[76px] mx-auto md:px-8 lg:flex-row lg:gap-6 lg:py-5 animate-fadeIn">
      {/* Mobile admin header */}
      <div className="fixed left-0 right-0 top-0 z-40 flex items-center justify-between border-b border-neutral-100 bg-white/95 px-4 py-3 shadow-sm backdrop-blur md:px-8 lg:hidden">
        <button
          type="button"
      ...
      <div className={`fixed inset-0 z-50 lg:hidden ${isMobileMenuOpen ? 'pointer-events-auto' : 'pointer-events-none'}`} aria-hidden={!isMobileMenuOpen}>
        <button
          type="button"
