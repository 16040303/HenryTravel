...
const blockedDates_1 = __importDefault(require("./blockedDates"));
...
const villaMedia_1 = __importDefault(require("./villaMedia"));
const villas_1 = __importDefault(require("./villas"));
const router = (0, express_1.Router)();
router.use('/auth', auth_2.default);
router.use('/villas', auth_1.adminAuthMiddleware, villaMedia_1.default);
router.use('/villas', auth_1.adminAuthMiddleware, villas_1.default);
router.use('/blocked-dates', auth_1.adminAuthMiddleware, blockedDates_1.default);
...
router.use('/media', auth_1.adminAuthMiddleware, media_1.default);
